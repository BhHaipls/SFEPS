...
public class MessageConfig implements WebMvcConfigurer {
    ...
    public static final String REQUEST_PARAM_LANGUAGE_NAME = "lang";

    public static Locale resolveLocale(HttpServletRequest req) {
        String language = req.getParameter(REQUEST_PARAM_LANGUAGE_NAME);
        return new Locale(language == null ? DEFAULT_LANGUAGE : language);
    }
